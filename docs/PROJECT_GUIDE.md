...
当前准备版本为 `v4.6.2`，本地实现与最终验证见 [RELEASE_4.6.2.md](RELEASE_4.6.2.md)。线上仍为 `v4.6.0`；生产统计迁移、Worker 与 v4 快照预热尚未执行（2026-09-24 SSH 只读已确认生产库无统计表、无 Worker），本文的候选能力不代表已经上线。
