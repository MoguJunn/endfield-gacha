...
本轮桌面 Demo 已完成本地实现并获用户验收，按用户要求于 2026-09-05 分阶段保存在本地主题分支 `feat/v4.5-desktop-home-demo`。提交顺序为首页 / 通知预览、个人 / 全服工作区、消息回归测试、文档与新任务；没有 push、合并或部署，正式站默认入口尚未切换。其他并行代码与此前文档候选保留在工作树中。
