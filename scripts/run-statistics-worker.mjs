...
const maxJobs = Number(process.env.STATISTICS_MAX_JOBS || 8);
if (!Number.isInteger(maxJobs) || maxJobs < 1 || maxJobs > 1000) throw new Error('Invalid STATISTICS_MAX_JOBS');
const results = await runStatisticsWorker(db, { maxJobs });
