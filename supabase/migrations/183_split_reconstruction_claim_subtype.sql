-- 183: split reconstruction weapon claims into their own product subtype.
...
-- Rebuild only the JSON overload. The pre-existing legacy positional overload
-- remains available so old callers can still write unclassified extras.
