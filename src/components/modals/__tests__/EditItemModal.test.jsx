...
const catalogItems = [
  { id: 'char-6', type: 'character', name: '角色六星', rarity: 6, aliases: ['测试角色'], avatar_url: '/avatars/characters/char-6.png' },
  { id: 'char-5', type: 'character', name: '角色五星', rarity: 5, aliases: [] },
  { id: 'weapon-6', type: 'weapon', name: '武器六星', rarity: 6, aliases: [], avatar_url: '/avatars/weapons/weapon-6.png' },
];
